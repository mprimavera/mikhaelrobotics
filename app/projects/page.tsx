...
<div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
  ...
  <p className="text-slate-500 lg:text-xl md:text-base max-w-3xl">
    ...
    of their software team at clean-room semiconductor fabrication facilities.
  </p>
</div>

<div className="min-h-screen flex flex-wrap justify-center gap-x-15 gap-y-20 mt-10 px-8 lg:px-50">
...
<BackgroundGradient className="rounded-[22px] p-4 sm:p-10 bg-white dark:bg-zinc-900 flex flex-col items-center h-[500px]">
    ...
    <p className="text-sm text-neutral-600 dark:text-neutral-400">
      ...
      kinemamtics. (The video was not intended for a presentation, just for my own personal reflection.)
    </p>
      </div>
...
<BackgroundGradient className="rounded-[22px] p-4 sm:p-10 bg-white dark:bg-zinc-900 flex flex-col items-center h-[500px]">    
    ...
    <p className="text-base sm:text-xl text-black mt-4 mb-2 dark:text-neutral-200">
      Embedded programming of PI control in C.
    </p>
    ...
    <p className="text-sm text-neutral-600 dark:text-neutral-400">
      ...
      as well as using the encoder to provide proportional and integral control. I've used derivative control for other projects,
